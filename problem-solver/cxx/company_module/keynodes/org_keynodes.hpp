...
class OrgKeynodes : public ScKeynodes
{
public:
  static inline ScKeynode const action_check_graph_isomorphism{
    "action_check_graph_isomorphism", ScType::ConstNodeClass};
  ...
  static inline ScKeynode const nrel_work_high_connection{
    "nrel_work_high_connection", ScType::ConstNodeNonRole};
  static inline ScKeynode const nrel_work_connection{
    "nrel_work_connection", ScType::ConstNodeNonRole};
};
